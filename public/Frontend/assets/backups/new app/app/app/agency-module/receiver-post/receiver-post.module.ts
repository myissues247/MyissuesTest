...
import { Server2Pipe } from './server2.pipe';
...
@NgModule({
  declarations: [ReceiverPostComponent, SelectCategoryComponent, LocationComponent, AdContentComponent, UserDetailsComponent, PhotosComponent, Server2Pipe, UpgradesComponent, FinalizeComponent],
  imports: [
    CommonModule,  
