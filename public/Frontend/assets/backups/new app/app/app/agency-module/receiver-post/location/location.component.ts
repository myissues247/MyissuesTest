...
export class LocationComponent implements OnInit, OnDestroy {
  ...
  ad : Ad;
  saved: boolean = false;
  constructor(private ds: UserDataService, private ps: AgencyAdServiceService, private router: Router, private loader: LoaderService, private ar: ActivatedRoute, private ss : StateService) { 
