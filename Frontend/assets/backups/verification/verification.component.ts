...
export class VerificationComponent implements OnInit {
  ...
  constructor(private router:Router, private ds: UserDataService, public ss: StateService, public ad:SponsorDataService, public loader: LoaderService) { 
  }
  ...
  getProfile() {
    this.spinner();
    this.ad.get_profile().subscribe((response)=>{
      this.stopSpin();
      if(response.status) {
  ...
  submit(form){
    ...
    this.ad.sponsor_verification().subscribe((events)=>{
