...
export class NavbarComponent implements OnInit, AfterViewInit {
  ...
  SignUp(form, closeButton){
    ...
    this.ds.AddUser({agencyTitle: this.titleProp, sponsorTitle: this.titleProp, firstname:this.nameProp,lastname:this.lastProp,email:this.mailProp,password:this.passwordProp,userType:this.roleProp.code}).subscribe((response)=>{
      if(response.status) {
