...
export class UserDetailsComponent implements OnInit, AfterViewInit, OnDestroy {  
  ...
  nextPage(form){
    //TODO : implement changes and unsaved data detection.
     ...
     var birthDate : any = new Date(form.value.dob)	 
     ...
     if(birthDate == 'Invalid Date') {
       return this.ps.newMessage('error', 'Invalid DOB', 'Invalid date of birth');
     }
     if(calculatedAge != form.value.age) {
        return this.ps.newMessage('error', 'Invalid DOB or Age', 'Age doesn\'t match year of birth');
     }
     this.load();
