...
export class PurchaseBumpsComponent implements OnInit, OnDestroy {
  ...
  constructor(private ps :AgencyDataService, private router : Router, private ss: StateService, private ds: UserDataService) { }
  ...
  buyBumps() {
    ...
    this.router.navigate(['/agency/bumps/pay-with-card'], {queryParams: {bumpId: bump._id, price: bump.price, count: bump.count}})
  }
